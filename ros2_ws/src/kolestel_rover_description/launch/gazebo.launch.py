...
def generate_launch_description():
    ...
    enable_livox_bridge = LaunchConfiguration('enable_livox_bridge')
    ...
    converter = Node(
        ...
        output='screen',
        condition=IfCondition(enable_livox_bridge),
        parameters=[{
            'input_topic': '/lidar',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('enable_livox_bridge', default_value='false'),
        ...
        TimerAction(period=12.0, actions=[converter, odom_tf, warehouse_visualizer]),
    ])
